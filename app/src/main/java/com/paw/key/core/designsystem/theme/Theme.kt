...
/*private val localPawKeyColors = staticCompositionLocalOf<DoggyWalkerColors> {
    error("No PawKeyColors provided")
}

private val localPawKeyTypography = staticCompositionLocalOf<DoggyWalkerTypography> {
